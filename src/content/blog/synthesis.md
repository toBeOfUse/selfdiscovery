...
This is something that Ezra Klein pointed out the initial impact of ChatGPT a long time ago, that I haven't been able to stop noticing, that I think is underrated in terms of importance:
...
Additionally, Vendure is an e-commerce platform, and e-commerce platforms are not exactly new upon this earth. In fact, thousands of people have been employed working on e-commerce, probably 24/7, in aggregate, for about the last 25 years. In other words, there are a lot of examples of this kind of thing in the training data. And Vendure doesn't try to re-invent that many wheels: at my job, when we've pulled apart other e-commerce platforms like Shopify and Target to see how they work, there've been echoes of how Vendure works all over the place: the same structure for collections, or the same extensive use of facets. The standard e-commerce wheels being used here all have roughly the same inner diameter and attached chrome spinners.
